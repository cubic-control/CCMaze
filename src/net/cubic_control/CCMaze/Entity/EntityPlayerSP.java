...
public class EntityPlayerSP{
    ...
    public EntityPlayerSP(Map map, int x, int y, InputManager input, String username) {
    ...
    public EntityPlayerSP() {
        ...
        if (Main.settings.playerID == 0){
        	this.playerIdle = new Animator(pIAS, new BufferedImage[]{Assets.spr_char0_idle1});
        	this.playerWalkingUp = this.playerIdle;
        	this.playerWalkingDown = this.playerIdle;
        	this.playerWalkingLeft = this.playerIdle;
        	this.playerWalkingRight = this.playerIdle;
        }else if (Main.settings.playerID == 1) {
    ...
    public void init() {
    	System.out.println("[System][INFO]:Initializing Player");
